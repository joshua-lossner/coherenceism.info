...
**Welcome to the age of coherence.**`
      ...
      case '/CONTACT':
        ...
        addLine("Facebook  - facebook.com/joshua.lossner", 'normal', false, 'https://www.facebook.com/joshua.lossner')
        addLine("X         - x.com/NeuromancerByte", 'normal', false, 'https://x.com/NeuromancerByte')
        addLine("LinkedIn  - [ CONNECTION DENIED: EXCESSIVE SUITS ]", 'normal')
        addLine("")
        addLine(createBorder(), 'normal')
        addLine("")
        break
